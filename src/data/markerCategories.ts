...
export const MARKER_CATEGORIES: MarkerCategory[] = [
  ...
  { type: 'animal-habitat', group: 'wildlife', label: 'Animal habitats', icon: 'Trees', color: '#6a8f4e', defaultOn: false, dense: true, markEntity: null },
  { type: 'herb', group: 'wildlife', label: 'Herbs', icon: 'Leaf', color: '#4e8f6a', defaultOn: false, dense: true, markEntity: null },
